...
// canister (https://github.com/dfinity/ic, mainnet principal
// mgi-tqaaaa-aaaar-qaqoa-cai). The bitcoin canister exposes typed methods (no
// JSON-RPC envelope), so unlike the ETH/SOL detectors we decode typed Candid
// directly instead of parsing JSON-RPC text. We declare ONLY the members this
// detector calls.
